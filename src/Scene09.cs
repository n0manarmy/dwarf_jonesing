...
[Signal]
public delegate void Scene09DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene09 : Node2D
{
    private String THIS_SCENE = "Scene09";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(16, 42);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene09DoneClicked), RETURN_POS, false);
        QueueFree();
    }

...
[Signal]
public delegate void Scene10DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene10 : Node2D
{
    private String THIS_SCENE = "Scene10";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(07, 32);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene10DoneClicked), RETURN_POS, false);
        QueueFree();
    }

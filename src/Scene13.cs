...
[Signal]
public delegate void Scene13DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene13 : Node2D
{
    private String THIS_SCENE = "Scene13";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(20, 11);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene13DoneClicked), RETURN_POS, false);
        QueueFree();
    }

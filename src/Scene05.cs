...
[Signal]
public delegate void Scene05DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene05 : Node2D
{
    private String THIS_SCENE = "Scene05";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(50, 31);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene05DoneClicked), RETURN_POS, false);
        QueueFree();
    }

...
[Signal]
public delegate void Scene03DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene03 : Node2D
{
    private String THIS_SCENE = "Scene03";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(52, 10);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene03DoneClicked), RETURN_POS, false);
        QueueFree();
    }

...
[Signal]
public delegate void Scene06DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene06 : Node2D
{
    private String THIS_SCENE = "Scene06";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(52, 43);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene06DoneClicked), RETURN_POS, false);
        QueueFree();
    }

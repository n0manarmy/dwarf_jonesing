...
[Signal]
public delegate void Scene12DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene12 : Node2D
{
    private String THIS_SCENE = "Scene12";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(07, 11);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene12DoneClicked), RETURN_POS, false);
        QueueFree();
    }

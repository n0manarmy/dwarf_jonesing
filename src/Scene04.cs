...
[Signal]
public delegate void Scene04DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene04 : Node2D
{
    private String THIS_SCENE = "Scene04";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(59, 21);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene04DoneClicked), RETURN_POS, false);
        QueueFree();
    }

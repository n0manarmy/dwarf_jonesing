...
[Signal]
public delegate void Scene11DoneClicked(Vector2 pos, bool disableLocButtons);

public class Scene11 : Node2D
{
    private String THIS_SCENE = "Scene11";
    private TravelPath travelPath;
    private TileMap travelPathTileMap;
    private Player player;
    private Sprite sprite;
    private Vector2 RETURN_POS = new Vector2(10, 21);
    ...
    public void OnDoneButtonClicked() {
        ...
        EmitSignal(nameof(Scene11DoneClicked), RETURN_POS, false);
        QueueFree();
    }
